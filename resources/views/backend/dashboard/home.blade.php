...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Latest Apllications</h4>
                        ...
                        <table class="table align-middle table-nowrap mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="align-middle">Application ID</th>
                            ...
                            <tbody>
                                @foreach ($applications as $application) 
                                    <tr>
                                        ...
                                        <td><a href="javascript: void(0);" class="text-body fw-bold">#VAAS{{$application->id}}</a> </td>
                                        <td>{{$application->applicant->name }} <br> {{$application->applicant->email }} </td>
                                        <td>
                                            {{$application->created_at}}
                                        </td>
                                        <td>
                                            @if ($application->application_price)
                                                {{ $application->application_price->price }}
                                            @else
                                                150,000 TZS
                                            @endif
                                        </td>
                                        <td> 
                                            {!! $application->getStageFormattedAttribute() !!}
                                        </td>
                                        <td>
                                            {!! $application->getPaymentFormattedAttribute() !!}
                                        </td>
                                        <td>
