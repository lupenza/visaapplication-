...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body ">
                    <h4 class="card-title text-center" >Add News</h4>
                    <form action="" id="registration_form" >
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label for="">Title</label>
                                <input type="text" name="title" class="form-control" placeholder="Write news Title ...." required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mt-2">
                            <div class="col-md-12">
                                ...
                                <textarea name="caption" class="form-control" placeholder="Write news Short Description...."></textarea>
                            </div>
                        </div>
                        <div class="form-group row mt-2">
                            <div class="col-md-12">
                                <label for="">Full News Description</label>
