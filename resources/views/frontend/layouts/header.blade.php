            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ul class="tg-header__top-right list-wrap">
                        <li><i class="flaticon-envelope"></i><a href="mailto:info@apexa.com">info@visa.com</a></li>
                ...
                <div class="col-12">
                    <div class="tgmenu__wrap">
                        <nav class="tgmenu__nav">
                            <div class="logo">
                                <a href='index.html'><img src="{{ asset('assets/frontend/img/logo/logo.png')}}" alt="Logo"></a>
                            </div>
                            ...
                            <div class="tgmenu__action tgmenu__action-three d-none d-md-block">
                                <ul class="list-wrap">
                                    ...
                                    <li class="header-btn"><a class='btn' href='#'> Apply Visa <i class="flaticon-arrow-right"></i></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="tgmobile__menu">
                        <nav class="tgmobile__menu-box">
                            ...
                            <div class="nav-logo">
                                <a href='index.html'><img src="assets/img/logo/logo.html" alt="Logo"></a>
                            </div>
                            ...
                            <div class="tgmobile__menu-bottom">
                                <div class="contact-info">
                                    <ul class="list-wrap">
                                        <li><a href="mailto:info@apexa.com">info@visa.com</a></li>
